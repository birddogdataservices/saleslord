...
// Returns JOBS_FIXTURES when no API keys are configured (stub-first pattern).
// Job signals decay harder than other sources (half-weight at 6 months).
...
// ─────────────────────────────────────────
// Fixtures (used when no job API keys)
// ─────────────────────────────────────────
...
const JOBS_FIXTURES: RawSignal[] = [
  {
    ...
    snippet: 'Senior ETL Developer at Maricopa County, Phoenix AZ: Required: Pentaho Data Integration (PDI/Kettle) 5+ years. Experience with Pentaho CE in production environment preferred.',
  ...
  },
  {
    ...
    snippet: 'Data Integration Engineer at Intermountain Health, Salt Lake City UT: Must have hands-on Pentaho PDI (Kettle) experience. Will maintain and extend existing CE-based ETL infrastructure.',
  ...
  },
  {
    ...
    snippet: 'ETL Developer at American Family Insurance, Madison WI: Technologies: Pentaho Kettle, Oracle Data Integrator. Experience migrating Pentaho CE workflows strongly preferred.',
  ...
  },
  {
    ...
    snippet: 'Data Engineer at City of Columbus, Columbus OH: Current stack includes Pentaho PDI for all nightly ETL processes. Candidate will support and extend existing Pentaho CE deployment.',
  ...
  },
  {
    ...
    snippet: 'BI/ETL Developer at Blue Cross Blue Shield of Minnesota, Eagan MN: Required skills include Pentaho Data Integration. Experience with Pentaho CE ETL pipelines in healthcare data environment.',
  ...
  },
  {
    ...
    snippet: 'Data Integration Specialist at Saskatchewan Health Authority, Regina SK: Maintain existing Pentaho Kettle ETL environment supporting provincial health data warehouse. PDI CE experience required.',
  ...
  },
  {
    ...
    snippet: 'ETL Developer at WPS Insurance, Green Bay WI: Pentaho PDI (Kettle) experience required. Will develop and maintain PDI transformations and jobs for insurance data warehouse.',
  ...
  },
  {
    ...
    snippet: 'Data Engineer at TransAlta Corporation, Calgary AB: Experience with Pentaho Data Integration (CE or EE). Will build and maintain ETL processes for energy trading and generation reporting.',
